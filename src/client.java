...
public class client implements ActionListener {
    ...
    client() { // frame coding should be here only
        ...
        // -------------------------------------------dp-----------------------------------------------------------------
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/dp1.png"));
        ...
        JLabel name = new JLabel("Aditya V Patil");
        ...
        send.setBackground(new Color(53, 94, 59));   //color of send button
        ...
        f.setLocation(800, 10); // location of frame as x y in the screen
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            vertical.add(Box.createVerticalStrut(10)); // 10 is gap b/w two vertical msgs
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                String msg = din.readUTF(); // will read the data in din,now client msg is stored in msg
                JPanel panel = formatLabelout(msg); // printing that msg into the panel or the interface of the server

                JPanel left = new JPanel(new BorderLayout());
                
                // left.setBackground(new Color(13,13,13));
